...
\end{figure}
We will use the identification of the thick blue part to glue on a $k$-handle. In our example from figure \ref{TorusMorse} this will look similar to the gluing in figure \ref{attach1handle}.
\printbibliography
\end{document}
